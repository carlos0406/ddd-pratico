...
import EnviaConsoleLogHandler from '../../customer/events/handler/envia-console-log.handler'
import EnviaConsoleLog1Handler from '../../customer/events/handler/envia-console1.handler'
import EnviaConsoleLog2Handler from '../../customer/events/handler/envia-console2.handler'
import { EventDispatcher } from '../../@shared/event/event-dispatcher'
import CustomerCreatedEvent from '../../customer/events/custumer-created.event'
import CustomerAddressChangedEvent from '../../customer/events/custumer-address-changed.event'
